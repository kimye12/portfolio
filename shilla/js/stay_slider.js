function autoSlide3(args) {
  ...
  function gotoSlider(first, second, third) {
    ...
    pagers[first % 3].classList.remove("active3");
    pagers[second % 3].classList.add("active3");
    currentIndex = third;
  ...
  function pagerSlide(i) {
    ...
    totalBox.forEach((box, index) => {
      ...
      pagers.forEach((pager) => {
        pager.classList.remove("active3");
      });
      pagers[i % 3].classList.add("active3");
    });
  }
